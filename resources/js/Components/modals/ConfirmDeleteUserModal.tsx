...
export default function ConfirmDeleteUserModal({ action, onClose }: ConfirmDeleteModalProps) {
                        ...
                        <form onSubmit={handleSubmit} className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4 flex flex-col gap-4">
                            ...
                            <div className="flex gap-2">
                                <Input
                                    type="checkbox"
                                    checked={data.force}
                                    onChange={() => setData("force", !data.force)}
                                    className="mt-1"
                                />
                                <div className="flex flex-col gap-1 text-sm">
                                    <span className="font-semibold">
                                        {t("content.force_delete_title")}
                                    </span>
                                    <p className="text-secondary text-xs">
                                        {t("content.force_delete_desc")}
                                    </p>
                                </div>
                            </div>
