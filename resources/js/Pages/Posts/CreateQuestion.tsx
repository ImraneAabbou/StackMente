            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                <Field className="flex lg:items-center flex-col lg:flex-row gap-4 justify-between max-w-3xl">
                    <div>
                        ...
                        <Description className="text-sm text-secondary">{t("posts.question_title_description")}</Description>
                ...
                <div>
                    <Field className="flex flex-col gap-4">
                        <div>
                            ...
                            <Description className="text-sm text-secondary">{t("posts.question_content_description")}</Description>
