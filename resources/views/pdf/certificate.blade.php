@php
    ...
    if (app()->getLocale() == 'ar') {
       function correct_ar_chars(string $t) {
            $Arabic = new \ArPHP\I18N\Arabic();
            $p = $Arabic->arIdentify($t);
            for ($i = count($p) - 1; $i >= 0; $i -= 2) {
              $utf8ar = $Arabic->utf8Glyphs(substr($t, $p[$i-1], $p[$i] - $p[$i-1]));
              $t = substr_replace($t, $utf8ar, $p[$i-1], $p[$i] - $p[$i-1]);
            }
            return $t;
       }
       $fullname = correct_ar_chars($fullname);
       $text = correct_ar_chars($text);
       $title = correct_ar_chars($title);
       $subtitle = correct_ar_chars($subtitle);
       $text = correct_ar_chars($text);
   }
@endphp
           <!DOCTYPE html>
 ...
 >
  ...
  .annotationLayer .buttonWidgetAnnotation.radioButton input {
    ...
    box-sizing: border-box;
    font: calc(9px * var(--scale-factor));
    height: 100%;
    margin: 0;
    vertical-align: top;
    width: 100%;
...
<span style="position:absolute; left: 45%; top: 85%; font-size: calc(var(--scale-factor)*25.03px); transform: scaleX(1.06546);" role="presentation" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">StackMente</font></font></span>
<span style="position:absolute;left: 25%;top: 13%;font-size: calc(var(--scale-factor)*40px);transform: scaleX(1.06546);" role="presentation"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$title}}</font></font></span>
<span style="position:absolute;left: 40%;top: 35.5%;font-size: calc(var(--scale-factor)*20px);transform: scaleX(1.06546);" role="presentation"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$subtitle}}</font></font></span>
<span style="position:absolute;left: 52%;top: 42%;font-size: calc(var(--scale-factor)*40.03px);transform: scaleX(1.06546);text-decoration: underline 2px lightgray;text-underline-offset: 5px;" role="presentation" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$fullname}}</font></font></span>
<span style="position:absolute;left: 45%;top: 53%;font-size: calc(var(--scale-factor)*15.03px);transform: scaleX(1.06546);display: block;width: 307px;" role="presentation"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$text}}</font></font></span>
