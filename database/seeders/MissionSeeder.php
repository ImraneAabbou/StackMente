    ...
    public function run(): void
    {
        $missions = collect([
            [
                ...
                'type' => MissionType::LOGIN_STREAK->value,
                'threshold' => 7,
            ],
            [
                'image' => fake()->imageUrl(128),
            ...
            [
                ...
                'type' => MissionType::XP_TOTAL->value,
                'threshold' => 5000,
            ],
            [
                'image' => fake()->imageUrl(128),
                ...
                'type' => MissionType::TOTAL_OWNED_POSTS->value,
                'threshold' => 20,
            ],
            [
                'image' => fake()->imageUrl(128),
                ...
                'type' => MissionType::TOTAL_MADE_COMMENTS->value,
                'threshold' => 50,
            ],
            [
                'image' => fake()->imageUrl(128),
                ...
                'type' => MissionType::RECEIVED_POSTS_VOTE_UPS->value,
                'threshold' => 100,
            ],
            [
                'image' => fake()->imageUrl(128),
                ...
                'type' => MissionType::RECEIVED_COMMENTS_VOTE_UPS->value,
                'threshold' => 75,
            ],
        ]);
